...
KNOWN_ISSUES_INTEGRATION = {
    ...
    'xfail_list': {
        ...
        'opensuse151': [
            'states/test_virtualenv_mod.py::VirtualenvTest::test_issue_2594_non_invalidated_cache',
            'states/test_pip_state.py::PipStateTest::test_pip_installed_specific_env',
            'states/test_pip_state.py::PipStateTest::test_pip_installed_removed_venv',
            'states/test_pip_state.py::PipStateTest::test_pip_installed_errors',
            'states/test_pip_state.py::PipStateTest::test_issue_6833_pip_upgrade_pip',
            'states/test_pip_state.py::PipStateTest::test_issue_2087_missing_pip',
            'states/test_pip_state.py::PipStateTest::test_issue_2028_pip_installed_state',
            'states/test_pip_state.py::PipStateTest::test_22359_pip_installed_unless_does_not_trigger_warnings',
            'modules/test_virtualenv_mod.py::VirtualenvModuleTest::test_site_packages',
            'modules/test_virtualenv_mod.py::VirtualenvModuleTest::test_create_defaults',
            'modules/test_pip.py::PipModuleTest::test_requirements_as_list_of_chains__cwd_set__absolute_file_path',
            'modules/test_pip.py::PipModuleTest::test_requirements_as_list_of_chains__cwd_not_set__absolute_file_path',
            'modules/test_pip.py::PipModuleTest::test_requirements_as_list__non_absolute_file_path',
            'modules/test_pip.py::PipModuleTest::test_requirements_as_list__absolute_file_path',
            'modules/test_pip.py::PipModuleTest::test_pip_uninstall',
            'modules/test_pip.py::PipModuleTest::test_pip_install_upgrade',
            'modules/test_pip.py::PipModuleTest::test_pip_install_multiple_editables_and_pkgs',
            'modules/test_pip.py::PipModuleTest::test_pip_install_multiple_editables',
            'modules/test_pip.py::PipModuleTest::test_issue_4805_nested_requirements',
            'modules/test_pip.py::PipModuleTest::test_chained_requirements__non_absolute_file_path',
            'modules/test_pip.py::PipModuleTest::test_chained_requirements__absolute_file_path',
            'modules/test_git.py::GitModuleTest::test_rebase',
        ],
        'opensuse152': [
            'states/test_virtualenv_mod.py::VirtualenvTest::test_issue_2594_non_invalidated_cache',
            'states/test_pip_state.py::PipStateTest::test_pip_installed_specific_env',
