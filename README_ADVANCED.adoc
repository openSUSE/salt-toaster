...
[source,python]
.https://github.com/openSUSE/salt-toaster/blob/master/conftest.py.source#L12-L289[conftest.py.source]
----
...
.https://github.com/openSUSE/salt-toaster/blob/master/configs/suse.tests/sles12sp1/products.cfg[`./configs/suse.tests/sles12sp2/products.cfg`]
----
[pytest]
addopts = --tb=short
